    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 bg-white border-b border-gray-100 z-10">
        <div className="flex items-center gap-4 px-4 py-4 max-w-3xl mx-auto">
          <Link href="/appx/welcome" className="h-10 w-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-gray-50">
      ...
      <div className="px-4 py-8 max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6">
            <h3 className="font-bold text-gray-900 mb-3">6. Contact Us</h3>
            <p>If you have any questions about this Privacy Policy, please contact us:</p>
            <p className="mt-2">
              Email: <a href="mailto:info@boldandbeyondcoaching.ae" className="text-[#0D9488] hover:underline">info@boldandbeyondcoaching.ae</a><br />
