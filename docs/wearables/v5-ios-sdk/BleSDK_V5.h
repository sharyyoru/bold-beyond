...
#import "BleSDK_Header_V5.h"
#import "DeviceData_V5.h"
@interface BleSDK_V5 : NSObject
/*!
 ...
 *
 */
-(NSMutableData*)SetDeviceTime:(MyDeviceTime_V5)deviceTime;
 ...
 *
 */
-(NSMutableData*)SetPersonalInfo:(MyPersonalInfo_V5)personalInfo;
 ...
 *
 */
-(NSMutableData*)SetAutomaticHRMonitoring:(MyAutomaticMonitoring_V5)automaticMonitoring;
 ...
 *
 */
-(NSMutableData*)manualMeasurementWithDataType:(MeasurementDataType_V5)dataType measurementTime:(int)measurementTime open:(BOOL)isOpen;
 ...
 *
 */
-(NSMutableData*)startActivityMode:(ACTIVITYMODE_V5)activityMode WorkMode:(WORKMODE_V5)workMode  ActivityTime:(int)activityTime BreathParameter:(MyBreathParameter_V5)breathParameter ;
 ...
 *
 */
-(DeviceData_V5*)DataParsingWithData:(NSData*_Nullable)bleData;
@end
